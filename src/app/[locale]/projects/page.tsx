...
const projects: Project[] = [
  ...
  {
    titleKey: "detective.title",
    descriptionKey: "detective.description",
    highlightsKey: "detective.highlights",
    tags: [
      "Python",
      "FastAPI",
      "Next.js",
    ...
    githubUrl: "https://github.com/BonayLeites/office_detective",
  },
];
                ...
                {project.featured ? (
                  ...
                  <div className="relative bg-white rounded-2xl border border-stone-200 overflow-hidden hover:border-stone-300 transition-colors">
                    <div className="p-8 md:p-10">
                      ...
                      <div className="relative rounded-xl overflow-hidden border border-stone-200 mb-8">
                        <Image
                          src="/images/office-detective-demo.gif"
                          alt="Office Detective — AI-powered corporate fraud investigation game"
                          width={1583}
                          height={777}
                          className="w-full h-auto"
                          unoptimized
